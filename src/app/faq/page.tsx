      ...
      <main id="main-content">
        ...
        <section className="py-10 px-6" style={{ background: 'linear-gradient(135deg, #4a2d8a, #2a8a76)' }}>
          <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <p className="font-body text-white/70 text-xs font-bold uppercase tracking-widest mb-1">Österreichischer Marktplatz Lernapps</p>
            ...
            <a
              ...
              className="shrink-0 inline-flex items-center gap-2 font-body font-bold text-sm px-6 py-3 rounded-xl bg-white text-[#4a2d8a] hover:bg-white/90 transition-all whitespace-nowrap">
              Lern-Apps das Programm bestellen
